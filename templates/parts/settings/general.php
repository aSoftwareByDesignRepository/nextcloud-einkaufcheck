...
<section class="ekc-card" aria-labelledby="ekc-pref-title">
	<header class="ekc-card__header">
		<h2 id="ekc-pref-title"><?php p($l->t('Your postcode')); ?></h2>
	</header>
	<div class="ekc-card__body">
		<form id="ekc-pref-form">
			<div class="form-group">
				...
				<p class="form-help" id="ekc-settings-plz-help"><?php p($l->t('Used to pick the nearest Lidl Plus store. ALDI Nord offers are the same nationwide.')); ?></p>
			</div>
			<div class="form-group">
